...
- R counts 0, 1 or many bindings, and once an object has many bindings there is no going back. So
  releasing a binding will not lead to the modification-in-place optimisation: one less than many is
  many.
